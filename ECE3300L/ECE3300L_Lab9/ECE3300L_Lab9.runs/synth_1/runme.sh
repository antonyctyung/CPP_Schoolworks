...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/ECE3300L_Lab9/ECE3300L_Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AlarmClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AlarmClock.tcl
