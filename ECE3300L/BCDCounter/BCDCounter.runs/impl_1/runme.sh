...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/BCDCounter/BCDCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCDCounter.tcl -notrace
