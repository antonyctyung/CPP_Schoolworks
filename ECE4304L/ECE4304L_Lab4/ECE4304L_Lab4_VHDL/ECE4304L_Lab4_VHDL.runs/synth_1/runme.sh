...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE4304L/ECE4304L_Lab4/ECE4304L_Lab4_VHDL/ECE4304L_Lab4_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctrl7seg.tcl
