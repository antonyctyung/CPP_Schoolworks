...
ISEStep( "vivado",
         "-log ThreeBitCounterOnSevenSegmentDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ThreeBitCounterOnSevenSegmentDisplay.tcl -notrace" );
