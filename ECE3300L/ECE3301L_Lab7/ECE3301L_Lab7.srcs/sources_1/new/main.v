...
module minuteClkGen (
    ...
    assign clkMinute = ~|second;               // posedge when all 0
endmodule
...
module main(
    ...
    clockGen     cgn(CLK100MHZ, BTNR, clk400Hz, clk1Hz);
    counter2bit  c2b(!BTNR,clk400Hz,1,select);
    dec2to4      dec(select,1,AN[3:0]);
    minuteClkGen mcg(second, clkMinute);
    counter60 sec(SW[ 5:0], BTNL, !BTNR, clk1Hz   , 1, second);
    counter60 min(SW[13:8], BTNL, !BTNR, clkMinute, 1, minute);
