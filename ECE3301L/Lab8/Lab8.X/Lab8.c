...
#define EW_LT_SW PORTBbits.RB5                                                                     // Defines EW_PED as PORTB bit RB5 for Ped-switch
#define EW_PED_SW PORTBbits.RB1                                                                      // Defines EW_LT as PORTB bit RB1 for left turn
...
void Old_Wait_One_Second()                                                                          // creates one second delay and blinking asterisk
{
    ...
    SEC_LED = 0;
    Wait_Half_Second();                                                                             // Wait for half second (or 500 msec)c
}
