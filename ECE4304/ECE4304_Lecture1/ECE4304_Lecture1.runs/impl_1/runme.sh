...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE4304L/ECE4304L_Lab1/ECE4304L_Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2x1.tcl -notrace
