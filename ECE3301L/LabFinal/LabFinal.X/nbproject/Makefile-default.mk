...
SOURCEFILES_QUOTED_IF_SPACED=Main.c I2C_Soft.c I2C_Support.c Interrupt.c Main_Screen.c Setup_Alarm_Time.c Setup_Fan_Temp.c Setup_Time.c TFT_ST7735.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Main.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/TFT_ST7735.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Main.p1.d ${OBJECTDIR}/I2C_Soft.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/Setup_Alarm_Time.p1.d ${OBJECTDIR}/Setup_Fan_Temp.p1.d ${OBJECTDIR}/Setup_Time.p1.d ${OBJECTDIR}/TFT_ST7735.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Main.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/TFT_ST7735.p1

# Source Files
SOURCEFILES=Main.c I2C_Soft.c I2C_Support.c Interrupt.c Main_Screen.c Setup_Alarm_Time.c Setup_Fan_Temp.c Setup_Time.c TFT_ST7735.c
...
${OBJECTDIR}/TFT_ST7735.p1: TFT_ST7735.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/TFT_ST7735.p1 TFT_ST7735.c 
