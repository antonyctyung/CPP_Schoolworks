...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE4304L/ECE4304L_Lab4/ECE4304L_Lab4_VHDL/ECE4304L_Lab4_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ctrl7seg.tcl -notrace
