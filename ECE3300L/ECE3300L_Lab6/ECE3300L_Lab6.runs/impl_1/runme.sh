...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/ECE3300L_Lab6/ECE3300L_Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ThreeBitCounterOnSevenSegmentDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ThreeBitCounterOnSevenSegmentDisplay.tcl -notrace
