...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/ECE3300L_Lab3_Assignment/ECE3300L_Lab3_Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AdderFPGAInterface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AdderFPGAInterface.tcl -notrace
