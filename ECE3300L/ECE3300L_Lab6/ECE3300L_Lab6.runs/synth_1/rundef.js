...
ISEStep( "vivado",
         "-log ThreeBitCounterOnSevenSegmentDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ThreeBitCounterOnSevenSegmentDisplay.tcl" );
