...
{                                                                       
    ...
    RBPU=0;
    TRISB = 0xFF;                                                                                   // Configure the PORTB for the External pins to make sure that all the INTx are inputs
