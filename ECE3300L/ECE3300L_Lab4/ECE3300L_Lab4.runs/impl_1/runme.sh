...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/ECE3300L_Lab4/ECE3300L_Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryToSevenSegmentDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BinaryToSevenSegmentDisplay.tcl -notrace
