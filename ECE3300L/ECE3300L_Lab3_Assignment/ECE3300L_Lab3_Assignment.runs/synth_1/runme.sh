...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/ECE3300L_Lab3_Assignment/ECE3300L_Lab3_Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AdderFPGAInterface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AdderFPGAInterface.tcl
