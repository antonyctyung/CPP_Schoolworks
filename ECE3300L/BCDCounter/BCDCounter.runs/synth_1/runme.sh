...
HD_PWD='D:/Documents/workspace/CPP_Schoolworks/ECE3300L/BCDCounter/BCDCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCDCounter.tcl
